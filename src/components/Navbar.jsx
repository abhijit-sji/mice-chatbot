    ...
    <nav className="section-bg w-full shadow-xl">
      <div className='flex justify-between  gap-10 py-3 md:py-5 container mx-auto'>
        ...
        <ul className={`absolute z-10 w-full h-screen flex flex-col gap-10 justify-center items-center bg-[#e2235e] transform duration-500 ease-in-out ${open ? 'left-0 top-0' : '-top-[2000px]  left-0'} `}>
          <Link to={'/'} className='text-lg font-semibold text-white hover:text-secondary rounded-md px-1'>Home</Link>
          <Link to={'/'} className='text-lg font-semibold text-white hover:text-secondary rounded-md px-1'>About</Link>
          <Link to={'/'} className='text-lg font-semibold text-white hover:text-secondary rounded-md px-1'>Dashboard</Link>
          <Link to={'/'} className='text-lg font-semibold text-white hover:text-secondary rounded-md px-1'>Get Started</Link>
        ...
        <ul className='md:flex hidden items-center space-x-5'>
          <Link to={'/'} className='text-xl font-semibold text-secondary hover:text-primary rounded-md px-1'>Home</Link>
          <Link to={'/'} className='text-xl font-semibold text-secondary hover:text-primary rounded-md px-1'>About</Link>
          <Link to={'/'} className='text-xl font-semibold text-secondary hover:text-primary rounded-md px-1'>Dashboard</Link>
          <Link to={'/'} className='text-xl font-semibold text-secondary hover:text-primary rounded-md px-1'>Get Started</Link>
        </ul>
